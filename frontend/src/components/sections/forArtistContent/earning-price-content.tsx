  ...
  return (
    <div className='mb-40 leftRightSpacing'>
        ...
        <div className='flex gap-2'>
            <EarnCard
             p1='At BeatBack, we believe in a straightforward and transparent commission structure. For every successful lease transaction on our platform, we take a 20% commission. '
            ...
            <EarnCard
             p1='BeatBack empowers artists with flexible payment schedules. Choose to receive your earnings  after each successful lease, opt for a monthly payout, or accumulate your earnings for an annual payment. '
