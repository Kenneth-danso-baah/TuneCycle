...
function HowItWorksHolder() {
  return (
    <div className=' space-y-5 mb-20 lg:mb-32 mx-5 lg:leftRightSpacing lg:mt-0'>
        <div>
            <h1 className='text-[22px] text-center text-nowrap font-monoBold uppercase mb-10 lg:mb-20 lg:text-5xl lg:text-start'>how it works</h1>
        </div>
