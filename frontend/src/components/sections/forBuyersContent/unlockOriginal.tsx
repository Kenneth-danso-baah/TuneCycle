...
function UnlockOriginalContent() {
  return (
    ...
    <div className='flex flex-col items-center space-y-5 mb-14'>
        <h1 className='text-[20px] text-center  font-monoBold md:text-3xl lg:text-start'>Unlock Original Sound with Master Rights Leasing</h1>
        <p className='w-full p-0  md:p-3  lg:p-0 text-center text-[18px] font-bold lg:w-[55%]'>Discover a world of unique, high-quality music for your projects. BeatBack offers artists the opportunity to lease their master recordings, granting you access
