    ...
    <div className='p-5  lg:p-0 mb-20 mt-10 md:mt-20 lg:mt-0 flex flex-col lg:flex-row items-center md:mb-32 gap-20'>
        ...
        <div className='lg:ml-20 flex-[100%]  md:flex-[50%] w-full space-y-5  md:space-y-10'>
            ...
            <div className='space-y-5'>
                 <h1 className='font-monoBold text-nowrap md:text-wrap text-[20px]  md:text-4xl'>Quick & Easy liscensing</h1>
                <p className='text-[18px]  md:text-[20px] font-bold w-[100%] md:w-[80%]'>Secure your license instantly. Our simple platform makes it quick and easy.</p>
            </div>
        ...
        <div className='lg:mr-20 flex-[50%] space-y-10 w-full'>
            ...
            <div className='space-y-5'>
                 <h1 className='font-monoBold text-2xl text-center md:text-left md:text-4xl capitalize'>Custom leases available</h1>
                <p className='text-[18px] font-bold md:text-[20px]'>Control your licensing. Negotiate directly with artists for the best deals.</p>
            </div>
