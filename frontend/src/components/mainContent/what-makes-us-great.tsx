...
import ExplainTextIcon from '../common/explain-text-icon'


function WhatMakesUsGreat() {
    return (
      <div className='mb-20 mb:mb-32'>
          <div className='flex items-center flex-col space-y-5'>
              <h1 className='text-3xl font-monoBold capitalize'>What makes beat back so great?</h1>
              <p className='text-[18px] font-bold'>Find out what makes us the best on the market</p>
          </div>
      
          <div className='flex flex-col lg:flex-row gap-20  items-center lg:gap-52 lg:justify-between mt-10 md:mt-20'>
  
               <div className='ml-20 flex-[50%] flex flex-col space-y-3 place-self-start'>
